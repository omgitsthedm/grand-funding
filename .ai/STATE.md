...
`.ai/RULES.md` was generated on 2026-06-28. Its root-publish and Git-push deployment commands are obsolete.

Do not hand-edit the generated file. Regenerate it through the canonical AI-Ops generator when that generator is available.
...
- 80 indexable pages
- 169 redirects
- 18 Really Simple Syndication items
...
- Forms: no production submission made
- Telemetry: blocked during verification
...
Google Ads labels remain dormant placeholders. The Porkbun DNS correction remains client-owned and unverified by this release.
